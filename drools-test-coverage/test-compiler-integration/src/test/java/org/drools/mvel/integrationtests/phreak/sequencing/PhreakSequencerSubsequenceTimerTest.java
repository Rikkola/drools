...
public class PhreakSequencerSubsequenceTimerTest extends AbstractPhreakSequencerSubsequenceTest {
    ...
    public void testSubSequenceFailSeq1() {
        ...
        assertThat(getSequenceStack(sequencerMemory).size()).isEqualTo(2);
        ...
        assertThat(getCurrentSequence(sequencerMemory).getSequence()).isEqualTo(seq1);
        ...
        assertThat(getCurrentStep(sequencerMemory)).isEqualTo(-1);
        assertThat(getSequenceStack(sequencerMemory).isEmpty()).isTrue();
    }
    ...
    public void testSubSequenceFailSeq2() {
        ...
        assertThat(getCurrentSequence(sequencerMemory).getSequence()).isEqualTo(seq2);
        assertThat(getCurrentStep(sequencerMemory)).isEqualTo(1);
