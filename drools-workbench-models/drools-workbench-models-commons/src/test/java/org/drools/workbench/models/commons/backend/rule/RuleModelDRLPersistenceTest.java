...
public class RuleModelDRLPersistenceTest extends BaseRuleModelTest {
    ...
    public void testActionSetFieldValueWithDSL() {
        ...
        try {
            ...
            aif.addFieldValue(new ActionFieldValue("applicationDate",
                                                   "13-Mar-2017",
                                                   DataType.TYPE_DATE));
            ...
            PackageDataModelOracle dmo = mock(PackageDataModelOracle.class);
            final RuleModel m2 = RuleModelDRLPersistenceImpl.getInstance().unmarshalUsingDSL(actual,
            ...
            assertEquals("applicationDate",
                         afv.getField());
            assertEquals("13-Mar-2017",
                         afv.getValue());
        } finally {
            if (oldValue == null) {
                System.clearProperty("drools.dateformat");
